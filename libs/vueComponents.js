(function(Vue, mui, common) {
	...
	Vue.component('my-select', {
		template: '<div style="display: flex; flex-direction: column;justify-content: flex-start; position:relative; width: 100%; height: 100%;">' +
			'<input readonly v-bind:value="value" :placeholder="placeholder" ref="input" v-on:change="change" v-on:focus="focus" v-on:blur="blur" type="text" style="flex:1;height: 100%; width: 100%; margin: 0; padding: 0 10px; padding-right:20px;" />' +
